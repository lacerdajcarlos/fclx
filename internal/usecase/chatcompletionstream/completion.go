...
import (
	...
	"github.com/lacerda.jcarlos/fclx/chatservice/internal/domain/gateway"
...
func (c ChatCompletionConfigInputDTO) ChatCompletionUseCase(repo *repository.ChatRepositoryMySQL, client *openai.Client) any {
	panic("unimplemented")
}
